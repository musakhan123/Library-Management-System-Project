...
void BorrowedBooksList::add(int bookID)
{
...
bool BorrowedBooksList::remove(int bookID)
{
...
bool BorrowedBooksList::contains(int bookID) const
{
    Node* current = head;
    while (current) {
...
int BorrowedBooksList::getSize() const
{
    return size;
}

void BorrowedBooksList::display() const
{
    Node* current = head;
    while (current) {
...
void BorrowedBooksList::copyFrom(const BorrowedBooksList& other)
{
...
{
    borrowedBookIDs = new BorrowedBooksList();
    if (other.borrowedBookIDs)
        borrowedBookIDs->copyFrom(*other.borrowedBookIDs);
}
...
void Student::clearBorrowedBooks() {
    if (borrowedBookIDs)
